...
export function seedData(): DB {
  return {
    ...
    sections: [
      { id: id('sec_hero'), key: 'hero', title: 'Hero', enabled: true, sort_order: 0, built_in: true },
      { id: id('sec_about'), key: 'about', title: 'About Me', enabled: true, sort_order: 1, built_in: true },
      { id: id('sec_skills'), key: 'skills', title: 'Skills', enabled: true, sort_order: 2, built_in: true },
      { id: id('sec_experience'), key: 'experience', title: 'Experience', enabled: true, sort_order: 3, built_in: true },
